/**
 * Seed script para crear citas de prueba para MAÑANA (25 de octubre de 2025)
 * 
 * Características:
...
// Fecha de mañana (25 de octubre de 2025)
...
async function createNonOptimalAppointments() {
  ...
  for (const appointment of nonOptimalRoute) {
    ...
    const appointmentData = {
      ...
      GSI2SK: `DATE#${TOMORROW}#TIME#${appointment.time}`
    };
  ...
  console.log(`\n✅ Total: ${appointments.length} citas creadas para ${TOMORROW}\n`);

  // Resumen de la ruta NO óptima
  console.log('📍 RUTA NO ÓPTIMA CREADA:');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  console.log('📊 ANÁLISIS DE DISTANCIAS:');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  let totalDistance = 0;
