/**
 * Seed script para crear citas de prueba para MAÑANA (23 de octubre de 2025)
 * 
 * Características:
...
// Fecha de mañana (23 de octubre de 2025)
...
async function main() {
  console.log('═'.repeat(60));
  console.log('🌱 SEED SCRIPT: Citas para Mañana (23 de octubre de 2025)');
  console.log('═'.repeat(60));
  console.log('\n📋 Características:');
